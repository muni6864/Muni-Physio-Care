...
<style>
    ...
    .main-title { 
        margin: 0 auto; 
        font-size: clamp(1.8rem, 6vw, 3rem); /* Responsive font scaling */
        font-weight: 700; 
        line-height: 1.2;
    ...
    .container { 
        ...
        gap: 30px; 
        max-width: 1280px; 
        margin: -60px auto 60px auto; /* Pulls the content up into the header */
        padding: 0 20px; 
        position: relative;
        z-index: 2;
    }
    ...
    .profile-img { 
        ...
        margin-top: -100px; /* Aligns photo half-in/half-out of the white card */
        margin-bottom: 15px;
        transition: 0.3s;
    }

    /* MOBILE OPTIMIZATIONS (The most important part) */
    @media (max-width: 900px) { 
        ...
        .main-title { 
            font-size: 1.8rem; /* Fixed size for mobile to prevent overflow */
            padding: 0 5px;
        }
    ...
    @media (max-width: 480px) {
        .services-grid { grid-template-columns: 1fr; } /* 1 per row for very small phones */
    }
    ...
    .btn { padding: 12px; border-radius: 12px; color: white; text-decoration: none; font-weight: 600; text-align: center; }
